        ...
        plugins: {
            ...
            tooltip: {
                ...
                external: ({ tooltip }) => {
                    ...
                    const rs = couters.find(i => i.data.find(n => n === Math.round(+tooltip.body[0]?.lines[0] * chart?.totalScore / 100)))
                    ...
                    <div className="flex-6 w-full h-full">
                        {data && (
                            <div className="w-full h-full relative">
                                ...
                                <div className='tooltip' style={{ position: 'absolute', opacity: tooltipState.opacity, left: tooltipState.left, top: tooltipState.top }}>
                                    <SongReleaseItem
                                        item={selectedItem}
